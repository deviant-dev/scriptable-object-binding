...
namespace Deviant.GameEvents {
	...
	public class GameVariableFloatRange : GameVariableFloat {
		...
		public float Progress { get { return (Value - m_MinValue) / (m_MaxValue - m_MinValue); } set { Value = Mathf.Clamp(value * (m_MaxValue - m_MinValue) + m_MinValue, m_MinValue, m_MaxValue); } }
